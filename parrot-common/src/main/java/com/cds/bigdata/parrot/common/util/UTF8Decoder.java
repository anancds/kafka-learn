...
/**
 * <p></p>
 * author chendongsheng5 2017/2/9 11:04
 * version V1.0
 * modificationHistory =========================逻辑或功能性重大变更记录
 * modify by user: chendongsheng5 2017/2/9 11:04
  ...
  public static CoderResult malformedN(ByteBuffer src, int nb) {
    switch (nb) {
      ...
      case 4: // we don't care the speed here
        b1 = src.get() & 0xff;
        b2 = src.get() & 0xff;
        if (b1 > 0xf4 || (b1 == 0xf0 && (b2 < 0x90 || b2 > 0xbf)) || (b1 == 0xf4
            && (b2 & 0xf0) != 0x80) || isNotContinuation(b2)) {
          return CoderResult.malformedForLength(1);
        }
        if (isNotContinuation(src.get())) {
